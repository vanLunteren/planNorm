...
#' It calculates the sample size and power of the design with an internal pilot study for different \cr
#' standard deviations and for multiple timings of the internal pilot studies.\cr
